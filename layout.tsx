...
:root {
  /* Baysset Palette: Cream, Ebony, Warm Gold, Terracotta, Deep Brown, Taupe */
  ...
  --primary: oklch(0.32 0.045 55);
  --primary-foreground: oklch(0.95 0.01 85);
  --secondary: oklch(0.73 0.07 75);
  --secondary-foreground: oklch(0.18 0.02 50);
  --muted: oklch(0.90 0.015 80);
  --muted-foreground: oklch(0.55 0.025 55);
  --accent: oklch(0.55 0.12 45);
  --accent-foreground: oklch(0.95 0.01 85);
  --destructive: oklch(0.55 0.12 45);
  --destructive-foreground: oklch(0.95 0.01 85);
  --border: oklch(0.85 0.02 75);
  --input: oklch(0.90 0.015 80);
  --ring: oklch(0.73 0.07 75);
  --chart-1: oklch(0.32 0.045 55);
  --chart-2: oklch(0.73 0.07 75);
  --chart-3: oklch(0.55 0.12 45);
  --chart-4: oklch(0.55 0.025 55);
  --chart-5: oklch(0.18 0.02 50);
  --radius: 0.5rem;
  --sidebar: oklch(0.95 0.01 85);
  --sidebar-foreground: oklch(0.18 0.02 50);
  --sidebar-primary: oklch(0.32 0.045 55);
  --sidebar-primary-foreground: oklch(0.95 0.01 85);
  --sidebar-accent: oklch(0.73 0.07 75);
  --sidebar-accent-foreground: oklch(0.18 0.02 50);
  --sidebar-border: oklch(0.85 0.02 75);
  --sidebar-ring: oklch(0.73 0.07 75);
}
